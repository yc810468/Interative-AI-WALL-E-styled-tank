...
int echoPin = 6;    //超音波感測器 Echo 腳接 Arduino pin 12
...
char ssid[] = "CA331";    // your network SSID (name)
char pass[] = "0933242063";        // your network password
...
void loop()
{
  ...
  Serial.println(" cm");
    ...
    while (Count < MaxNumValue) {
        ...
        else if (bleReciveData[Count].reciveCMDFlag) {
